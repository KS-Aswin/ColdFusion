...
<body>
    <form class = "signUpForm my-5" id ="formTarget" action = "?action=excel" method = "post" enctype="multipart/form-data">
        ...
        <div class="d-flex col-12 flex-column gap-3 justify-content-start align-items-center mb-4">
            ...
            <button class = "signUpCancel signUpSubmit " type = "reset"><a title = "Clear All" href = "">Cancel</a></button>
        </div>
    <p class="table table-hover">#variables.objExcel#</p>
    </form>
