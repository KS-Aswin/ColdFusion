<cfoutput>
        <ul class="nav justify-content-center border-bottom  pt-5 mt-5 pb-3 col-12">
            ...
            <li class="nav-item"><a href="../controllers/pages.cfc?method=doLogOut" title="Go to Log In" class="nav-link px-2 text-body-secondary">Log Out</a></li>
        </ul>
    </body>
</html>
</cfoutput>